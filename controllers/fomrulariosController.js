...
module.exports = {
  ...
  async crearCarnetDesparasitacion(req, res) {
    try {
      ...
      console.log("params: ", params);
      const CarnetsDesparasitacionCreada =
        await FormulariosService.crearCarnetDesparacitacion(params);
  ...
  async crearAtencionVeterinaria(req, res) {
    try {
      ...
      console.log("params: ", params);
      const AtencionVeterinaria =
        await FormulariosService.crearAtencionVeterinaria(params);
